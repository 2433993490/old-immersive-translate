...
const twpConfig = (function () {
  ...
  const defaultConfig = {
    ...
    enableImageOCR: "no",
    ocrApiProvider: "ocrspace", // ocrspace custom
    ocrApiKey: "",
    ocrApiEndpoint: "",
    ocrApiExtraHeaders: "{}", // JSON object string
    ocrApiResponsePath: "ParsedResults.0.ParsedText", // for custom provider
